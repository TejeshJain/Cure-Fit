...
export const loadDoctor = () => async dispatch => {
    ...
    try {
        const res = await axios.get('https://curefit.onrender.com/api/authDoctor');
...
export const register = ({ name, email, password }) => async dispatch => {
    ...
    try {
        const res = await axios.post('https://curefit.onrender.com/api/doctors', body, config);
        console.log(res);
...
export const login = (email, password) => async (dispatch) => {
    ...
    try {
        const res = await axios.post('https://curefit.onrender.com/api/authDoctor', body, config);
