...
export const getAppointments = () => async dispatch => {
    try {
        const res = await axios.get('https://curefit.onrender.com/api/authUser');
        dispatch({
...
export const addAppointment = (doctorId, formData, history) => async dispatch => {
    ...
    try {
        const res = await axios.post(`https://curefit.onrender.com/api/appointment/${doctorId}`,formData, config);
        dispatch({
...
export const deleteAppointment = (appointmentId) => async dispatch => {
    try {
        const res = await axios.delete(`https://curefit.onrender.com/api/authUser/${appointmentId}`);
        dispatch({
...
export const deleteAccountUser = () => async dispatch => {
    if(window.confirm('Are you sure? this can not be undone!')) {
        try {
            await axios.delete('https://curefit.onrender.com/api/authUser');
